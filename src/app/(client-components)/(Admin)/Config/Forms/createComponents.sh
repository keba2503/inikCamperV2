...
# Contenido base para cada componente
component_template() {
...
# Crea cada componente en el directorio actual
for component in "${components[@]}"; do
    component_path="${component}.js"
    component_content=$(component_template $component)
