...
import SkeletonGuide from '@/components/SkeletonGuide'; // Importa el componente SkeletonGuide
...
const Page = () => {
        ...
        fetch('/api/config')
            ...
            .then((data) => {
                const filteredData = data.find(
                    (item: ApiResponse) => item.scope_id === 5,
                );
    ...
    if (loading) {
        return <SkeletonGuide />; // Usar el componente SkeletonGuide durante la carga
    }
